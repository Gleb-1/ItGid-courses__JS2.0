...
function f1() {
  let input_1 = document.querySelector(".i-1").value;
  d1.push(input_1);
  showArr(".out-1", d1);
}
...
function f4() {
  let input_4 = document.querySelector(".i-4").value;
  d1.push(input_4);
  showArr(".out-4", d1);
}
...
function f5() {
  let input_5 = document.querySelector(".i-5").value;
  d1.unshift(input_5);
...
function f8() {
  let input_8 = document.querySelector(".i-8").value;
  let d8Row = [];
  d8Row[0] = input_8;
  if (input_8 != "") {
...
let d15 = [0, 2, 5, -4, 6, 22, -9, -12, 8, 13, 78];
