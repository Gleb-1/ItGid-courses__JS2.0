...
function t7() {
    // document.querySelector('.out-7').style.background = `rgb( ${t6(0,255)}, ${t6(0,255)}, ${t6(0,255)} )`;
    // let rand = min -0.5 + Math.random() * ( max - min +1 );
    // return Math.round(rand); 
}

document.querySelector('.b-7').onclick = function () {
    // document.querySelector('.out-7').style.background = `rgb( ${t7()}, ${t7()}, ${t7()} )`;
    document.querySelector('.out-7').style.background = `rgb( ${t6(0,255)}, ${t6(0,255)}, ${t6(0,255)} )`;
}
...
document.querySelector('.b-9').onclick = function () {
    document.querySelector('.out-9').textContent = t9(2);
}
