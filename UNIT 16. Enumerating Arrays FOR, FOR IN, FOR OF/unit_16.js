...
function f3() {
  let allDiv = document.getElementsByClassName('out-3');
...
function f4() {
  let allDiv = document.querySelectorAll('.out-4');
  for (let item of allDiv) {
    item.innerHTML += ' ' + 4;
  }
}
...
function f9() {
  ...
  document.querySelector('.out-9').innerHTML = ar;
}
...
function f15() {
  let allDiv = document.querySelectorAll('.out-15');
  for (let item of allDiv) {
    item.innerHTML = 15;
  }
}
