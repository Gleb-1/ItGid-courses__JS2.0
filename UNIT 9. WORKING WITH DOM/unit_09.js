...
out_1.style.width = 200 +'px';
out_1.style.height = 40 +'px'
}
...
function f5() {
document.querySelector('.out-5').innerHTML = out_4.classList.contains('bg-4');
}
...
divNew.textContent = 12;
divNew.classList.add('bg-12');
document.querySelector('.out-12').append(divNew);
}
...
function f13() {
let divNew = document.createElement('div');
divNew.innerHTML = 'pushMe';
divNew.classList.add('bg-13');
document.querySelector('.out-13').append(divNew);
divNew.onclick = f13_1;
}
...
let divNew = document.createElement('div');
divNew.innerHTML = 14;
divNew.classList.add('bg-14');
document.querySelector('.out-14').prepend(divNew);
}
...
dinNew.innerHTML = 15;
dinNew.classList.add('bg-15');
document.querySelector('.out-15').before(dinNew);
}
...
function f16() {
    ...
    dinNew.innerHTML = 15;
    dinNew.classList.add('bg-15');
    document.querySelector('.out-16').after(dinNew);
}
...
function f17() {
    ...
    dinNew.innerHTML = 15;
    dinNew.classList.add('bg-15');
    document.querySelector('.out-17').replaceWith(dinNew);
}
...
function f19() {
let out = '';
let allAttribute = document.querySelectorAll('.p-19');
    for ( let item of allAttribute ) {
...
document.querySelector('.but-21').onclick = function() {
    let input_21 = document.querySelector('.i-21').value;
    let liNew = document.createElement('li');
    liNew.innerHTML = input_21;
    document.querySelector('.u-21').prepend(liNew);
    let checkBox = document.getElementById('c-21');
    console.log(checkBox);
    if ( checkBox.checked ) {
        liNew.classList.add('bg-14');
    }
    else {
        document.querySelector('.u-21').prepend(liNew);
    }
