...
function f4() {
    let out = '';
checkBox = document.querySelector('.i-4');
    if ( checkBox.checked ) out += true;
    else out += false
...
function f5() {
let out = '';
checkBox = document.querySelector('.i-5');
    if ( checkBox.checked ) out += checkBox.value;
    else out += false;
...
function f6() {
let hiddenIn = document.querySelector('.i-6').value;
document.querySelector('.out-6').innerHTML = hiddenIn;
}
...
function f7() {
    let out = '';
let inputI_7 = document.querySelector('.i-7').value;
    if ( inputI_7.length >= 6 ) out += 1;
    else out += 0;
 
document.querySelector('.out-71').innerHTML = inputI_7;
...
out_8.innerHTML = `<input type = "text" class = "i-81"><button class = "b-81">Click</button><div class ="out-81"></div>`;
out_8.classList.toggle('hide');
document.querySelector('.b-81').onclick = f81;
       function f81 () {
let inputI_81 = document.querySelector('.i-81').value;
document.querySelector('.out-81').innerHTML = inputI_81;
       }
...
let radio = document.querySelector('.r-9');
    if ( radio.checked ) out += radio.value;
    else  out += 0;
...
function f10() {
let colorI = document.querySelector('.i-10').value;
document.querySelector('.out-10').style.backgroundColor = colorI;
}
...
function f11() {
let colorI_111 = document.querySelector('.i-111').value;
let colorI_112 = document.querySelector('.i-112').value;
document.querySelector('.i-111').style.backgroundColor = colorI_112;
document.querySelector('.i-112').style.backgroundColor = colorI_111;
}
...
function f12() {
let dataName = document.querySelector('.i-12').value;
document.querySelector('.out-12').innerHTML = dataName;
}
...
document.querySelector('.out-13').innerHTML = inputRange;
}
...
function f15() {
let inputI_15 = document.querySelector('.i-15').value;
document.querySelector('.t-15').innerHTML = inputI_15
document.querySelector('.out-15').innerHTML = inputI_15;
}
...
function f16() {
    let out = '';
let allOption = document.querySelectorAll('.s-16');
    for ( let i = 0; i < allOption.length; i++ ) {
        out += allOption[i].value;
    }
...
function f17() {
let out = '';
let allOption = document.querySelectorAll('.s-17');
    for ( let i = 0; i < allOption.length; i++ ) {
        out += allOption[i].value;
    }
...
// function f17() {
//     document.querySelector('.out-17').innerHTML = this.value;
//     }
...
function f18() {
    document.querySelector('.i-18').value = this.value;
}
...
function f19() {
let out = '';
    out += document.querySelector('.i-191').value  + ' ';
    out += document.querySelector('.i-192').value;
