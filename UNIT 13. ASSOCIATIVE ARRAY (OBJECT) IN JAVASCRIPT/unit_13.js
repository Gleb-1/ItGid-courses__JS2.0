...
function f6() {
  let input_1 = document.querySelector('.i-61').value;
  let input_2 = document.querySelector('.i-62').value;
  a6[input_1] = input_2;
  f5(a6, '.out-6');
  console.log(a6);
}
...
// function showLoop(arr, domen) {
//   let out = '';
//   for (let i = 0; i < arr.length; i++) {
//     out += arr[i] + ' ';
//   }
//   document.querySelector(domen).innerHTML = out;
// }
...
function f19() {
  ...
  for (let key in a19) {
    for (let i = 0; i < a19[key].length; i++) {
      if (input == a19[key][i].toLowerCase()) {
        out += key;
      }
    }
  }
